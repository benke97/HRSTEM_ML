...
class Particle_Interface_Point_Set_Generator:
    ...
    def move_point_set_down(self,point_set1, point_set2, a):
        ...
        while True:
            ...
            if min_distance < a:
                ...
                moved_point_set1[:, 1] -= 0.001  # Move all points in set1 down by 1 in y-axis

        return moved_point_set1.tolist()
    
    def rotate_and_displace_point_set(self, point_set):
    ...
    def generate_random_point_set(self):
        ...
        filtered_points_particle = self.apply_random_displacement(filtered_points_particle,self.particle_lattice_constant/20)
        filtered_points_support = self.apply_random_displacement(filtered_points_support,self.support_lattice_constant/20)
        ...
        point_set = self.rotate_and_displace_point_set(point_set_df)
        return point_set